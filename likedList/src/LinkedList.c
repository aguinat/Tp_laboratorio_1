...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    //pFunc es el criterio por el que se va a ordenar
    //retorna si corresponde o no ordenar
    ...
    if(this != NULL && (order == 0 || order == 1) && pFunc != NULL){
    	...
    	do{
    		...
    		len--;
    		for(int i= 0; i<len; i++){
    			auxElement = ll_get(this, i); // se guardan las dos direcciones de memoria que se van a comparar.
